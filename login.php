				...
				<div class="col-sm-6" style="border-right: 2px solid #000000; background-color: #e3e3e3;">
					...
					<form method="POST" action="actions/act_login.php">
						...
						<div class="form-group">
							<input type="text" class="form-control input-lg" placeholder="TPIN..." name="username" required>
						</div>
						<div class="form-group">
					...
					?>
					<br>
					<p class="text-center">Don't have an account? <a href="register.php">Register</a> | Forgot password? Reset it <a href="admin/forgot_password.php">Here!</a></p>
					<br>
				</div>
